...
# Function to generate and write an encryption key
def write_key():
    key = Fernet.generate_key()
    with open("key.key", "wb") as key_file:
        key_file.write(key)

# Uncomment the below line to generate the key for the first time
write_key()
...
# Function to load and display the passwords
def load_passwords():
